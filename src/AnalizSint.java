...
public class AnalizSint 
{
	...
	//  FormalArgListOpcional ::= FormalArgList | <vacio>
	 ...
	 private void E7() throws Exception
	 {
		 ...
		 if ((TokenActual.Token.compareTo("<!>") == 0)|| (TokenActual.Token.compareTo("<Suma>") == 0)|| (TokenActual.Token.compareTo("<Resta>") == 0))
			 ExpressionUnary();
		 else if ((TokenActual.Token.compareTo("<Identificador>")==0) || (TokenActual.Token.compareTo("<null>")==0) || (TokenActual.Token.compareTo("<true>")==0)|| (TokenActual.Token.compareTo("<false>")==0)|| (TokenActual.Token.compareTo("<Numero_Entero>")==0)|| (TokenActual.Token.compareTo("<Carácter>")==0)|| (TokenActual.Token.compareTo("<Cadena Caracteres>")==0)|| (TokenActual.Token.compareTo("<this>")==0)|| (TokenActual.Token.compareTo("<.>")==0)||(TokenActual.Token.compareTo("<(>")==0)|| (TokenActual.Token.compareTo("<new>")==0)||(TokenActual.Token.compareTo("<super>")==0))
			 	Primary();
		 		  		...
		 		  		if (TokenActual.Token.compareTo("<;>")== 0 )
						 	...
						 	Block();
		 	  	  			...
		 	  	  			if (TokenActual.Token.compareTo("<for>") == 0)
	 	 						...
	 	 						else throw new Exception("Linea " + TokenActual.Linea + " Columna " + TokenActual.Columna+ ": ERROR: Se esperaba un ; o alguna sentencia");
	 }
